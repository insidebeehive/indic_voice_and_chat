...
def build_chatbot_system_prompt(
    ...
    if has_player_tools:
        player_scope = (
            ...
            "rule does NOT apply to tool results. Only summarise if the list is genuinely "
            "very long (10+ items) and even then mention the total count and show the most "
            "relevant items, never just one. "
    ...
    parts.append(
        ...
        "Step 3 — WAIT FOR CONFIRMATION. Wait for the customer to confirm (yes / okay / "
        "sure / please do / etc.) before calling the tool. If they decline, keep trying "
        "to help. Once confirmed, call `escalate_to_human` immediately — writing "
