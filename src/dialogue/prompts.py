...
def build_chatbot_system_prompt(
    ...
    if has_player_tools:
        player_scope = (
            ...
            "brief holding message (e.g. 'I'm looking into your account right now, please "
            "give me a moment') and do not interrogate the customer further. If the tool "
            "still fails after retrying, tell the customer honestly that you are unable to "
