...
from src.auth.seed import patch_campaign_parameterize_company, patch_campaign_remove_sir, seed_campaigns_if_empty, seed_if_empty, seed_provider_costs, sync_telephony_from_yaml
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    await patch_campaign_parameterize_company(sessionmaker)
